...
const BuisnessCard = () => {
    return (
        ...
        <div className='p-3 relative'>
            ...
            <i className='top-[-12%] md:top-[-9%] absolute'><div className='flex ml-8'><IoIosMan className='text-2xl text-white mt-[11.8px]'></IoIosMan> <h4 className='text-2xl font-bold text-white text-center mt-2 ml-2'>MALE</h4> </div> </i>
        </div>
    </div>
    );
};
