    ...
    return (
        ...
        <main className=' bg-[#F7F7FD] '>
            <section className=' container mx-auto p-3 min-h-screen'>
                <div>
                    <h2 className='font-bold md:text-3xl text-2xl my-4 text-left '>Search Properties to Rent</h2>

                    <div className='grid grid-cols-12 gap-3 bg-white rounded-xl p-3 font-bold w-full'>
                        <input type="search" name="" id="" placeholder='Search' className=' md:col-span-6 col-span-full px-3 p-3 md:p-0 focus:outline-none border-1 rounded-lg border-gray-200  ' />
                        <input type="search" name="" id="" placeholder='Location' className='md:col-span-6 col-span-full px-3 p-3 md:p-0 focus:outline-none border-1 rounded-lg border-gray-200  ' />
