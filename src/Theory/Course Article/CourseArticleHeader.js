...
const CourseArticleHeader = () => {
    ...
    return (
        <div className=' bg-[#1E2736]   shadow-xl '>
            {/* header desktop */}
            <head className='hidden lg:flex justify-between items-center max-w-[1440px] mx-auto p-3 z-10 '>
            ...
            {/* header mobile */}
            <header>
                <div className='flex lg:hidden items-center justify-between mx-6 py-2'>
