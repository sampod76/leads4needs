...
export const Users = () => {
    return (
        <div className='max-w-[1440px] mx-auto bg-[#1e2736] min-h-screen text-white p-3 space-y-3'>
            ...
            <div className='flex justify-between items-center md:mx-7 '>

                <h3>CodeExampler</h3>
                <div className='hidden md:flex justify-between gap-4'>
                    <h6 className='text-base'>QUIZ</h6>
                    <h6 className='text-base'>TUTORIAL</h6>
                    <h6 className='text-base'>CERIFICATE</h6>
                    <h6 className='text-base'>EXAMS</h6>
                </div>
            ...
            <hr />
            <div className='flex gap-2 md:mx-7'>
                <h6>Followers</h6>
                <h6 className='text-blue-400'>Following</h6>
            </div>
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:mx-7 gap-3'>
