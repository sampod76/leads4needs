...
const UplodeImgCard = ({ img }) => {
    ...
    return (
        <div className=' h-20 md:h-28 lg:h-36 w-full bg-black rounded-lg relative'>
            ...
            >
                <div>
                    <div className='flex justify-end w-full'>
                        <button onClick={closeImgModal} className='text-lg border-2 px-3 py-2 mb-2 rounded-full'>X</button>
                    ...
                    <div className='flex justify-end'>
                        <button className='bg-blue-500 px-3 py-2 rounded-lg text-lg text-white my-2'>Delete</button>
