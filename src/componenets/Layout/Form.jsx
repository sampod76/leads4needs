    ...
    return (
        <div>
            ...
            <div className=' flex py-3  '>
                <h5 className='text-[#262064] font-poppins font-semibold px-32'>Leads4Needs</h5>
                <div className=' ml-[452px] font-poppins text-[12px]'>
                    ...
                    <button className=' bg-[#7065F0] px-4 py-[6px] rounded-md text-white'>Log In</button>
                </div>
            </div>
                ...
                <div className='flex gap-32'>
                    ...
                    <div className='h-[400px]  p-4 w-[420px] ml-28 rounded-md bg-[#7065F0]'>
                        ...
                        <div className=' mt-3 flex gap-3'>
                            <img src="https://images.pexels.com/photos/874158/pexels-photo-874158.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" className=' h-[80px] rounded-full w-[80px]' alt="" />
                            <div className=' mt-4 '>
                                <h5 className=' font-poppins font-semibold text-white text-[20px]'>Bruce Kent</h5>
                                <p className=' font-poppins  text-white text-[15px]'>Software Engineer</p>
                            </div>
                        </div>
                        <hr className=' scroll-mt-2 text-white' />
                        <div className='flex gap-3 '>
                            <IoIosCall className='text-white h-6 w-6' />
                            <span className=' font-semibold font-poppins mt-1 text-[12px] text-white'>9876543210 (Whatsapp)</span>
                        </div>

                        <div className='flex gap-3 mt-1'>
                            <AiOutlineMail className='text-white h-5 w-5' />
                            <span className=' font-semibold font-poppins mt-1 text-[12px] text-white'>brucekent@gmail.com</span>
                        </div>

                        <div className='flex gap-3 mt-1'>
                            <TiLocation className='text-white h-6 w-6' />
                            <span className=' font-semibold font-poppins mt-1 text-[12px] text-white'>Los Angeles, USA</span>
                        </div>

                        <div className=' mt-5 flex gap-4'>
                         <h5 className='text-[10px] font-poppins font-semibold text-white'>Approved Businesses</h5>
                         <h5 className='text-[10px] font-poppins font-semibold text-white'>Views</h5>
                        </div>
                        <div className=' flex gap-32'>
                         <h5 className='text-[10px] font-poppins font-semibold text-white'>5</h5>
                         <h5 className='text-[10px] font-poppins font-semibold text-white'>304</h5>
                        </div>
                    ...
                    <div className='  '>
                        <h5 className=' font-poppins text-[30px] py-3 font-semibold'>Add PG</h5>
                        <div className='mt-2'>
                        <div className=' '>
                            <div className='flex flex-col '>
                                <label htmlFor="Pg name" className=' font-poppins text-[#5B5B5B] text-[15px]'> PG Name</label>
                                <input type="text" placeholder='' className=' h-8 w-[420px] rounded-md border-[1.5px] border-[#E4E4E4]' />
                            </div>
                            ...
                            <div className='font-poppins text-[#5B5B5B] mt-3'>
                                ...
                                <div className=' mt-1  flex'>
                                    <span className='bg-[#F1F0FE] border-1 border-[#7065F0] font-poppins font-semibold text-[12px] rounded-md text-[#7065F0] px-12 py-2'>Male</span>
                                    <span className=' border-1 border-[#E4E4E4] ml-3 font-poppins font-semibold text-[12px] rounded-md text-[#5B5B5B]  px-12 py-2'>Female</span>
                                    <span className=' border-1 border-[#E4E4E4] ml-3 font-poppins font-semibold text-[12px] rounded-md text-[#5B5B5B] px-12 py-2'>Unisex</span>
                                </div>
                            </div>
                            <div className='font-poppins text-[#5B5B5B] mt-3'>
                                <label htmlFor="">Types of Room Sharing</label>
                                <div className=' mt-1  flex'>
                                    <span className='bg-[#F1F0FE] border-1 border-[#7065F0] font-poppins font-semibold text-[12px] rounded-md text-[#7065F0] px-4 py-2'>1 Room</span>
                                    <span className=' border-1 border-[#E4E4E4] ml-3 font-poppins font-semibold text-[12px] rounded-md text-[#5B5B5B]  px-4 py-2'>2 Room</span>
                                    <span className=' border-1 border-[#E4E4E4] ml-3 font-poppins font-semibold text-[12px] rounded-md text-[#5B5B5B] px-4 py-2'>3 Room</span>
                                    <span className=' border-1 border-[#E4E4E4] ml-3 font-poppins font-semibold text-[12px] rounded-md text-[#5B5B5B] px-4 py-2'>4 Room</span>
                                </div>
                            </div>
                            ...
                            <div className='mt-4'>
                                ...
                                <div className='flex gap-4'>
                                    <div className='flex flex-col '>
                                        ...
                                        <input type="text" placeholder='' className=' h-8 w-52 mt-2 rounded-md border-[1.5px] border-[#E4E4E4]' />
                                    </div>
                                    <div className='flex flex-col '>
                                        <label htmlFor="Pg name" className=' font-poppins font-semibold text-[#5B5B5B] text-[14px]'> Double Room Price</label>
                                        <input type="text" placeholder='' className=' mt-2 h-8 w-52 rounded-md border-[1.5px] border-[#E4E4E4]' />
                                    </div>
                                </div>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <div className='flex justify-end mt-2'>
                                        <button className='bg-[#7065F0] font-poppins text-[12px] px-5 py-[10px] font-semibold mr-2 rounded-md text-white  '>Reject</button>
                                        <button className='bg-[#7065F0] font-poppins text-[12px] px-5 py-[10px]  font-semibold rounded-md text-white '>Approve</button>
