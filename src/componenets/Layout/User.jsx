    ...
    <div>
      ...
      >
        <div className="bg-[#7065F0]  rounded-tl-md rounded-tr-md">
          <AiOutlineClose className=" cursor-pointer absolute ml-[90%] mt-4 h-5 w-5 text-white" />
      ...
      >
        ...
        <div className="px-32 -mt-5 -mb-4">
          <h5 className="text-[25px] font-semibold">{users && users.length}</h5>
        </div>
        ...
        <div className="h-[600px] w-[1010px] rounded-md border-1 border-purple-200 ml-32">
          <div className="flex gap-[420px]">
            ...
            <div className=" py-3 flex gap-2">
              <button className="bg-[#7065F0] text-[13px] text-white  py-1 flex rounded-md px-2  " onClick={deleteHandler}>
