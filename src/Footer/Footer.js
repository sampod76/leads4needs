...
const Footer = () => {
    return (
        <div className=''>
            <div className='bg-[#7065F0] relative max-w-full mx-auto'  >
                <div className='bg-[#7065F0] h-[25rem] smm:h-[25rem] md:h-[25rem] mdd:h-[20rem]  lg:h-[20.75rem] lgg:h-80 absolute w-full  top-0 mx-auto z-5'>
                    <h1 className='lgg:text-[17rem] lg:text-[15.625rem] mdd:text-[12.375rem]  flex justify-center  md:text-[12rem] smm:text-[10rem] text-[5rem] font-extrabold text-[#776DF1] mt-28 md:-mt-4'>PG Wars</h1>
                </div>
                <div className=' absolute z-10  w-full pt-4 px-2 md:px-0'>
                    <div className=' md:flex justify-around max-w-[1440px] mx-auto md:p-4 p-2  md:pt-10 text-white space-x-5'>

                        <div className='text-white space-y-1 md:ml-[3rem] md:w-[30%] mdd:w-[25%] ml-4'>
                            <p className='font-bold text-3xl'>PG Wars</p>
                    ...
                    <div className='w-[92%] pb-0 -mt-4 md:-mt-2 max-w-[1440px] mx-auto'>
                        <hr className='bg-white ml-[2%]' />
                        <p className='text-white text-start sm:text-sm smm:text-sm ml-2 md:ml-9 lg:ml-12 text-[12px] md:text-lg'>2022 CodeExampler | Designed By CodeExampler.com | All Right Reserved
                        </p>
                    </div>
                </div>
            </div>
