...
const Card = () => {
    return (
        <div>
            <div className='lggg:w-[20rem] lggg:h-[29rem] md:w-[19rem] md:h-[29rem] lg:w-[20rem] lg:h-[32rem]   bg-[#7065F0] rounded-2xl flex flex-col justify-between lg:px-6 lg:py-7 py-2 px-3 text-white ' >
                    ...
                    <div>
                        <div className='flex items-center'>
                            ...
                            <div className='space-y-3 ml-2 '>
                                ...
                                <h2 className='tracking-wide text-lg'>Software Engineer</h2>
                            </div>
                        </div>
